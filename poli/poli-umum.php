...
<head>
    ...
    <title>Poli Umum - Melo Health</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-green-500 to-blue-500 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl font-bold mb-4">Poli Umum</h1>
            <p class="text-xl max-w-2xl mx-auto">Pemeriksaan kesehatan umum dan pengobatan dasar untuk berbagai keluhan kesehatan.</p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Pengobatan Penyakit Ringan</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Imunisasi</span>
                                ...
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Deteksi Dini Penyakit</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                ...
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Pemeriksaan Gula Darah</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                            ...
                            <ol class="list-decimal pl-5 space-y-2 text-gray-600">
                                ...
                                <li>Pemeriksaan oleh dokter umum</li>
                                <li>Pengambilan resep (jika diperlukan)</li>
                                <li>Pembayaran di kasir</li>
                                <li>Apotek (jika ada resep)</li>
                            </ol>
                            
                            <h3 class="text-xl font-bold mt-6 mb-3 text-gray-800">Tips Menjaga Kesehatan Umum</h3>
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg shadow-md p-6 mb-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=100" alt="Dr. Budi Santoso" class="w-16 h-16 rounded-full object-cover mr-4">
                                <div>
                            ...
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=100" alt="Dr. Siti Aminah" class="w-16 h-16 rounded-full object-cover mr-4">
                                <div>
                                    <h4 class="font-bold text-gray-800">Dr. Siti Aminah</h4>
                            ...
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1559839734-2b71ea811ec6?auto=format&fit=crop&w=100" alt="Dr. Andi Pratama" class="w-16 h-16 rounded-full object-cover mr-4">
                                <div>
                                    <h4 class="font-bold text-gray-800">Dr. Andi Pratama</h4>
                    ...
                    <div class="bg-green-50 rounded-lg shadow-md p-6">
                        ...
                        <p class="text-gray-600 mb-4">Lakukan pemeriksaan kesehatan secara rutin untuk menjaga kesehatan tubuh Anda.</p>
                    ...
                    <div class="bg-blue-50 rounded-lg shadow-md p-6 mt-8">
                        ...
                        <ul class="space-y-2 text-gray-600">
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-info-circle text-blue-600 mt-1 mr-2"></i>
                                <span>Sebutkan riwayat alergi jika ada</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-info-circle text-blue-600 mt-1 mr-2"></i>
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Poli: <span class="font-medium">Poli Umum</span></p>
                </div>
    ...
    <script>
        ...
        function konfirmasiAntrian() {
            ...
            window.location.href = '../user/ambil-antrian.php?poli_id=3';
        }
