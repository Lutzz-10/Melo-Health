...
<body class="bg-gray-50">
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg shadow-md p-6 mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <img src="../assets/images/lutz.png" alt="Dr. Lutfi" class="w-16 h-16 rounded-full object-cover mr-4">
                                <div>
                                    <h4 class="font-bold text-gray-800">Dr. Lutfi</h4>
                            ...
                            <div class="flex items-center">
                                <img src="../assets/images/seli.png" alt="Dr. Seli" class="w-16 h-16 rounded-full object-cover mr-4">
                                <div>
                                    <h4 class="font-bold text-gray-800">Dr. Seli</h4>
                    ...
                    <div class="bg-green-50 rounded-lg shadow-md p-6">
                        ...
                        <button onclick="ambilAntrianPoliUmum()" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-md transition duration-300">
                            Ambil Nomor Antrian
                        </button>
                    </div>
    ...
    <script>
        ...
        // Ambil antrian function for Poli Umum
        function ambilAntrianPoliUmum() {
