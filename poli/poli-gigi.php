...
<body class="bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-green-500 to-blue-500 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl font-bold mb-4">Poli Gigi</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    ...
                                    <span>Pemeriksaan Gigi Rutin</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Pembersihan Karang Gigi (Scaling)</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Penambalan Gigi (Tambal Gigi)</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                ...
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Perawatan Saluran Akar (Root Canal)</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Pemutihan Gigi (Bleaching)</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
                                    <span>Pemeriksaan dan Pemasangan Behel</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                            ...
                            <ol class="list-decimal pl-5 space-y-2 text-gray-600">
                                ...
                                <li>Mengisi formulir identitas dan riwayat kesehatan</li>
                                <li>Menunggu panggilan nomor antrian</li>
                                <li>Pemeriksaan oleh dokter gigi</li>
                            ...
                            <ul class="space-y-2 text-gray-600">
                                ...
                                <li>• Menggunakan benang gigi secara rutin</li>
                                <li>• Berkumur dengan mouthwash</li>
                                <li>• Menghindari makanan terlalu manis</li>
                                <li>• Melakukan pemeriksaan rutin setiap 6 bulan</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-green-50 rounded-lg shadow-md p-6">
                        ...
                        <button onclick="ambilAntrianPoliGigi()" class="w-full bg-green-600 hover:bg-green-700 hover:scale-105 text-white font-bold py-3 px-4 rounded-md transition-all duration-500 ease-in-out">
                            Ambil Nomor Antrian
                        </button>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg shadow-md p-6 mt-8">
                        ...
                        <ul class="space-y-2 text-gray-600">
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-info-circle text-blue-600 mt-1 mr-2"></i>
                                <span>Waktu tunggu maksimal 2 jam</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-info-circle text-blue-600 mt-1 mr-2"></i>
    ...
    <script>
        ...
        function konfirmasiAntrian() {
            ...
            window.location.href = '../user/ambil-antrian.php?poli_id=1';
        }

        // Ambil antrian function for Poli Gigi
        function ambilAntrianPoliGigi() {
